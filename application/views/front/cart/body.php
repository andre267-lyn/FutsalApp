						...
						<div class="col-lg-12">
							<?php if (!empty($cek_keranjang->lapangan_id)) { ?>
								<a href="<?php echo base_url('cart/empty_cart/') . $customer_data->id_trans ?>">
									<button name="hapus" type="button" class="btn btn-danger" aria-label="Left Align" title="Kosongkan Keranjang" OnClick="return confirm('Apakah Anda yakin?');" style="background-image: linear-gradient(to right, #B5030F, #EE0919); color: white;">
										<span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Kosongkan
									</button>
								</a>
							<?php } ?>
							<a href="<?php echo base_url() ?>">
								<button name="hapus" type="button" class="btn btn-primary" aria-label="Left Align" title="Lanjut Belanja" style="background-image: linear-gradient(to right, #21ADC9, #0A829A); color: white;">
									<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Lanjut Belanja
								</button>
							</a>
							<?php if ($cek_keranjang != NULL) { ?>
								<button name="checkout" type="submit" class="btn btn-success" aria-label="Left Align" title="Checkout" style="background-image: linear-gradient(to right, #067E2A, #16B545); color: white;">
